...
const sendForm = async () => {
  await formStore.sendFilledStep()
...
const showUserPickableOption = computed(() => {
  return !(newJson.value.metaData.currentStep + 1 >= newJson.value.steps.length)
})
</script>
